...
- **Speech recognition:** from noise signal, infer the word that was pronounced
- **Tracking objects:** infer orientation and position of a rocket with some measurements.
